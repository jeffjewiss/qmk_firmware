 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  MT(MOD_LCTL, KC_ESC),  KC_A,   MT(MOD_LCTL, KC_S),    MT(MOD_LALT, KC_D),    MT(MOD_LGUI, KC_F),    KC_G,                     KC_H,    MT(MOD_RGUI, KC_J),    MT(MOD_RALT, KC_K),    MT(MOD_RCTL, KC_L),    KC_SCLN, KC_QUOT,
...
[_RAISE] = LAYOUT(
  ...
  KC_F1,  KC_F2,    MT(MOD_LCTL, KC_F3),   MT(MOD_LALT, KC_F4),   MT(MOD_LGUI, KC_F5),   KC_F6,                       _______, MT(MOD_RGUI, KC_LEFT), MT(MOD_RALT, KC_UP), MT(MOD_RCTL, KC_DOWN),   KC_RGHT, XXXXXXX,
